    ...
    int nCmdShow)
{
    ...
    button_1 = CreateWindow("button", "1", WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON,
        10, 149, 30, 30, hwnd, HMENU(1), hInstance, NULL);
    button_2 = CreateWindow("button", "2", WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON,
        43, 149, 30, 30, hwnd, HMENU(2), hInstance, NULL);
    button_3 = CreateWindow("button", "3", WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON,
        76, 149, 30, 30, hwnd, HMENU(3), hInstance, NULL);
    button_4 = CreateWindow("button", "4", WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON,
        10, 116, 30, 30, hwnd, HMENU(4), hInstance, NULL);
    button_5 = CreateWindow("button", "5", WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON,
        43, 116, 30, 30, hwnd, HMENU(5), hInstance, NULL);
    button_6 = CreateWindow("button", "6", WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON,
        76, 116, 30, 30, hwnd, HMENU(6), hInstance, NULL);
    button_7 = CreateWindow("button", "7", WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON,
        10, 83, 30, 30, hwnd, HMENU(7), hInstance, NULL);
    button_8 = CreateWindow("button", "8", WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON,
        43, 83, 30, 30, hwnd, HMENU(8), hInstance, NULL);
    button_9 = CreateWindow("button", "9", WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON,
        76, 83, 30, 30, hwnd, HMENU(9), hInstance, NULL);
    button_Zero = CreateWindow("button", "0", WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON, 43,
        182, 30, 30, hwnd, HMENU(Zero), hInstance, NULL);
    button_Plus = CreateWindow("button", "+", WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON, 119,
        149, 30, 30, hwnd, HMENU(Plus), hInstance, NULL);
    button_Minus = CreateWindow("button", "-", WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON, 119,
        116, 30, 30, hwnd, HMENU(Minus), hInstance, NULL);
    button_Multiply = CreateWindow("button", "*", WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON, 119,
        83, 30, 30, hwnd, HMENU(Multiply), hInstance, NULL);
    button_Divided = CreateWindow("button", "/", WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON, 119,
        50, 30, 30, hwnd, HMENU(Divided), hInstance, NULL);
    button_Equally = CreateWindow("button", "=", WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON, 119,
        182, 30, 30, hwnd, HMENU(Equally), hInstance, NULL);
    button_Point = CreateWindow("button", ".", WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON, 76,
        182, 30, 30, hwnd, HMENU(Point), hInstance, NULL);
    button_C = CreateWindow("button", "C", WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON, 43, 50,
        30, 30, hwnd, HMENU(ClearAll), hInstance, NULL);
    button_NEG = CreateWindow("button", "-/+", WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON, 10,
        182, 30, 30, hwnd, HMENU(Negative), hInstance, NULL);
